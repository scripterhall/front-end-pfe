...
import { ChartParcoursComponent } from "../dialogs/chart-parcours/chart-parcours.component";
...
export class MapComponent implements OnInit {
  ...
  openChart(sprint:Sprint){
    const dialogRef = this.dialogChart.open(ChartParcoursComponent, {
      width: '70%',
      height: '70%',
      position: {
        top: '90px',
